...
<!-- システムに対する変更が安全かどうかの保証はされておらず、なるべく安全に変更するために、多くの時間を割きます。 -->
<!-- 自動化が進んでいるからこそ、不明であることが異常に対する「恐怖」をうみます。 -->
<!-- システムの振る舞いがまるで「自然現象」に感じられる -->
<!-- 振る舞いの解明に多くの時間をとられたり、わざと自動化を避けて、人間の判断をはさもうとすることがある -->
...
- [ito08]: 伊藤直也, 勝見祐己, 田中慎司, ひろせまさあき, 安井真伸, 横川和哉著, 「［24時間365日］サーバ/インフラを支える技術 ……スケーラビリティ，ハイパフォーマンス，省力運用」, 技術評論社, 2008/08, https://gihyo.jp/magazine/wdpress/plus/978-4-7741-3566-3
